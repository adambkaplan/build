...
- Install the Shipwright deployment. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.13.0-rc2/release.yaml --server-side
...
- Install the Shipwright strategies. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.13.0-rc2/sample-strategies.yaml --server-side
  ```
...
| [v0.13.0-rc2](https://github.com/shipwright-io/build/releases/tag/v0.13.0-rc2)    | [Docs @ v0.13.0-rc2](https://github.com/shipwright-io/build/tree/v0.13.0-rc2/docs) | [Examples @ v0.13.0-rc2](https://github.com/shipwright-io/build/tree/v0.13.0-rc2/samples) |
